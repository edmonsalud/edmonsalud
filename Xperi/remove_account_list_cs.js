    ...
    function (log, search) {
        ...
        function fieldChanged(scriptContext) {
            ...
            if (scriptContext.sublistId == 'line' && (scriptContext.fieldId == 'account' || scriptContext.fieldId == 'department' || scriptContext.fieldId == 'class')) {
                ...
                if ((account_text.indexOf('5') != 0 && account != '') && (department != 211 && department != '')) {
                    alert('Accounts that do not start with 6XXXX should only have department 0000 - Corporate')
                    currentRec.setCurrentSublistValue({
                        sublistId: 'line',
                        fieldId: 'department',
        ...
        function validateLine(scriptContext) {
            ...
            if (sublistName == 'line') {
                ...
                log.debug('department validate line', department)
                log.debug('account validate line', account)
                log.debug('department_txt validate line', department_txt)
                log.debug('department_txt validate line', account_text)
                if (((account_text.indexOf('5') == 0 || account_text.indexOf('4') == 0) && account != '') && (class_item == '' || class_item == null)) {
                    alert('Accounts that starts with 5XXX and 4XXXX should have a class')
                    // currentRec.setCurrentSublistValue({
                    //     sublistId: 'line',
                    //     fieldId: 'account',
                    //     value: '',
